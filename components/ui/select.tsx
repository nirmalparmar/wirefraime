...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "focus:bg-foreground/[0.08] focus:text-foreground data-[state=checked]:bg-foreground/[0.08] data-[state=checked]:text-foreground not-data-[variant=destructive]:focus:**:text-foreground relative flex min-h-8 w-full cursor-default items-center gap-2 rounded-lg px-2.5 py-1.5 text-[12px] leading-none outline-hidden select-none data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-3.5 *:[span]:last:flex *:[span]:last:items-center *:[span]:last:gap-2",
        className
      )}
      {...props}
    >
