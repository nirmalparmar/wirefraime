    ...
    <section className="relative overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-5 pb-16 pt-32 text-center md:px-12 md:pb-24 md:pt-44">
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-3 animate-[fadeUp_0.6s_0.24s_ease_both]">
          <Button variant="clay" size="2xl" className="shadow-[0_0_24px_rgba(234,88,12,0.12)]" asChild>
            <Link href="/dashboard">
              Start building free
          ...
          <div className="liquid-glass-adaptive overflow-hidden rounded-xl">
            ...
            <div className="flex items-center justify-between border-b border-foreground/[0.06] px-5 py-3">
              ...
              <span className="text-xs font-medium text-muted-foreground">
                checkout-flow.wf · 5 screens
              </span>
              <div className="w-20" />
            </div>

            {/* Canvas */}
            <div className="grid grid-cols-2 gap-2 p-4 md:grid-cols-4 md:gap-3.5 md:p-7">
              {[
                ...
                <div
                  key={screen.label}
                  className={`liquid-glass-adaptive rounded-lg p-2 transition-colors md:p-3.5 ${screen.active ? "ring-1 ring-primary/40" : ""
                    }`}
                >
                  <div
                    className={`mb-1.5 text-[10px] font-bold uppercase tracking-widest md:mb-2.5 ${screen.active ? "text-primary" : "text-muted-foreground"
                      }`}
                  >
                    {screen.label}
                  </div>
                  <div className="sk mb-1 h-1.5 w-[85%] rounded-sm bg-foreground/10 md:h-2" />
                  <div className="sk2 mb-1 h-1 w-3/5 rounded-sm bg-foreground/10 md:h-1.5" />
                  <div
                    className={`sk3 mt-1.5 h-2 w-full rounded md:mt-2.5 md:h-3 ${screen.active ? "bg-primary/15" : "bg-foreground/5"
                      }`}
                  />
                </div>
              ))}
            ...
            {/* Status bar */}
            <div className="flex items-center gap-2.5 border-t border-foreground/[0.06] px-5 py-2.5 text-xs font-medium text-muted-foreground">
              <div className="sk size-1.5 rounded-full bg-green-500 shadow-[0_0_8px_rgba(34,197,94,0.5)]" />
              <span>5 screens · 3 flows · Generated in 2.1s</span>
        ...
        <div className="reveal mt-12 md:mt-16">
          <div className="liquid-glass-adaptive overflow-hidden rounded-xl">
            ...
            <div className="grid min-h-[200px] md:grid-cols-2">
              {/* Left: typing prompt */}
              <div className="flex flex-col border-b border-foreground/[0.06] p-5 md:border-b-0 md:border-r md:p-7">
